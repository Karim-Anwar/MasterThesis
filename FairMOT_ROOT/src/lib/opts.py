...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--data_dir', type=str, default='FairMOT_ROOT/src/lib/datasets/dataset')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'mot': {'default_resolution': [1080, 1920], 'num_classes': 1, # [608, 1088] old resolution
