...
def eval_seq(opt, dataloader, data_type, result_filename, save_dir=None, show_image=True, frame_rate=5, use_cuda=True):
    if save_dir:
    ...
    for i, (path, img, img0) in enumerate(dataloader):
        ...
        for t in online_targets:
            ...
            # print(vertical)
            # print(tlwh[2] * tlwh[3])
            # print(f"Frame {frame_id}: {tlwh[2] * tlwh[3] > opt.min_box_area and not vertical}")
